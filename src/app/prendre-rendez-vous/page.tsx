    ...
    <div className="py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-stone-600">{t.booking.subtitle}</p>
        </div>
        ...
        {siteConfig.booking.enableCalendly && siteConfig.booking.calendlyUrl && (
          <Card className="mb-8">
            ...
            <div className="bg-stone-50 rounded-lg p-4 min-h-[600px] flex items-center justify-center">
        ...
        <Card className="mt-12 bg-stone-50">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-stone-600">{t.booking.policyText}</p>
            </div>
            <div>
